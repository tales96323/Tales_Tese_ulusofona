# Tese de Mestrado — R5 (versão LaTeX)

Versão LaTeX da dissertação **"Uma perspectiva de engenharia sobre a evolução de algoritmos de ranqueamento baseada em grafos"**, R5.

## Estrutura

```
transformed_doc_R5_latex/
...
Ver `Mudancas_R5.md` (na pasta-mãe) para mapeamento completo das
melhorias relativas ao R4. Em resumo:
